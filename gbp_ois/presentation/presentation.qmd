...
3. Authorities will mitigate yield curve steepening by active **debt management**, reducing the average maturity of new issuance. HMT should also prioritises spending restraint and tax rises with lower implementation risk (eg re-profiling fixed investment plans).   
